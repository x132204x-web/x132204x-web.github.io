...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="contact section-wide" id="contact"><div className="contact-inner"><p className="eyebrow">06 / CONTACT</p><h2>如果你也在<br /><em>探索一些可能。</em></h2><p>欢迎交流 AI 产品、技术探索和未来机会。</p><div className="contact-links"><a href="mailto:hello@shiqixia.com">hello@shiqixia.com <Arrow /></a><a href="https://github.com" target="_blank" rel="noreferrer">GitHub <Arrow /></a><a href="#contact">个人简历 PDF <Arrow /></a></div></div></section>
